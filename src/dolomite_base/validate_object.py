...
def register_validate_object_function(type: str, fun: Optional[Callable] = None): 
    """
    ...
    """
    if fun is None:
        lib.deregister_validate_object_function(type)
    else:
        lib.register_validate_object_function(type, fun)
